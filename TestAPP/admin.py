...
class UsrScoreReturnAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'high_worth', 'rounds', 'sdate', 'msisdn', 'score_usr_worth', 'score_usr_cover_pecpt',
...
#admin.site.register(CellBasicInfo)
#admin.site.register(CellParaTable)
#admin.site.register(UsrAppPecpt)
#admin.site.register(UsrAppRank)
#admin.site.register(UsrBasicInfo)
#admin.site.register(UsrCallPecpt)
#admin.site.register(UsrCompltRecord)
#admin.site.register(UsrCorePecpt)
#admin.site.regiseter(UsrCoverPecpt)
#admin.site.register(UsrEtePecpt)
#admin.site.register(UsrExpenses)
#admin.site.register(UsrSpeedPecpt)
#admin.site.register(UsrResidentCell)
#admin.site.register(UsrScoreReturn)
